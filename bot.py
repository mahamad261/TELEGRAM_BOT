...
# CONFIGURATION
# ----------------------------------------------------
# BOT_TOKEN is read from environment variables (secure).
...
# --- debug: remove these two lines after everything works ---
logger.info("BOT_TOKEN present = %s | length = %s | prefix = %s",
            bool(BOT_TOKEN), len(BOT_TOKEN), BOT_TOKEN[:12])
...
async def main():
    ...
    try:
        ...
        logger.critical(
            ...
            "Double-check that the token in Railway's Variables is correct and was not "
